...
import net.adadev.browser5g.constant.DESKTOP_USER_AGENT
import net.adadev.browser5g.constant.MOBILE_USER_AGENT
...
import net.adadev.browser5g.network.NetworkConnectivityModel
