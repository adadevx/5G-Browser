 ...
 */
package net.adadev.browser5g.database.history

import net.adadev.browser5g.database.HistoryEntry
import net.adadev.browser5g.database.databaseDelegate
import net.adadev.browser5g.extensions.firstOrNullMap
import net.adadev.browser5g.extensions.useMap
