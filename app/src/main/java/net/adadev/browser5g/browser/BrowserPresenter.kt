...
import net.adadev.browser5g.constant.INTENT_ORIGIN
...
import net.adadev.browser5g.view.BundleInitializer
import net.adadev.browser5g.view.LightningView
import net.adadev.browser5g.view.TabInitializer
import net.adadev.browser5g.view.UrlInitializer
