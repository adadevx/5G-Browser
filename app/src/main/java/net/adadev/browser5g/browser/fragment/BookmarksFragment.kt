...
import net.adadev.browser5g.animation.AnimationUtils
import net.adadev.browser5g.browser.BookmarksView
import net.adadev.browser5g.browser.TabsManager
import net.adadev.browser5g.browser.bookmark.BookmarkUiModel
...
import net.adadev.browser5g.di.NetworkScheduler
...
import net.adadev.browser5g.extensions.drawable
import net.adadev.browser5g.favicon.FaviconModel
...
import net.adadev.browser5g.utils.UrlUtils
