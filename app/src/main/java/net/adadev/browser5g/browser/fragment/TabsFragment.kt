package net.adadev.browser5g.browser.fragment

import net.adadev.browser5g.BuildConfig
import net.adadev.browser5g.R
import net.adadev.browser5g.browser.TabsManager
import net.adadev.browser5g.browser.TabsView
import net.adadev.browser5g.browser.fragment.anim.HorizontalItemAnimator
import net.adadev.browser5g.browser.fragment.anim.VerticalItemAnimator
import net.adadev.browser5g.controller.UIController
import net.adadev.browser5g.di.injector
import net.adadev.browser5g.extensions.color
import net.adadev.browser5g.extensions.desaturate
import net.adadev.browser5g.extensions.drawTrapezoid
import net.adadev.browser5g.preference.UserPreferences
import net.adadev.browser5g.utils.DrawableUtils
import net.adadev.browser5g.utils.ThemeUtils
import net.adadev.browser5g.utils.Utils
import net.adadev.browser5g.view.BackgroundDrawable
