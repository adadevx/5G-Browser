package net.adadev.browser5g.dialog

import net.adadev.browser5g.MainActivity
import net.adadev.browser5g.R
import net.adadev.browser5g.constant.HTTP
import net.adadev.browser5g.controller.UIController
import net.adadev.browser5g.database.Bookmark
import net.adadev.browser5g.database.asFolder
